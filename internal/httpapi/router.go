...
func NewRouter(opts RouterOptions) http.Handler {
	...
	mux.HandleFunc("GET /api/v1/docs/openapi.yaml", api.handleOpenAPIDocument)
	mux.HandleFunc("GET /api/v1/docs/recent", api.handleRecentDocs)
	...
	mux.HandleFunc("GET /api/v1/message-favorites", api.handleListMessageFavorites)
	...
	mux.HandleFunc("POST /api/v1/conversations/{conversationId}/messages/forward", api.handleForwardMessages)
	mux.HandleFunc("POST /api/v1/conversations/{conversationId}/messages/favorite", api.handleFavoriteMessages)
	mux.HandleFunc("POST /api/v1/conversations/{conversationId}/messages/delete", api.handleDeleteMessagesForMe)
	mux.HandleFunc("PATCH /api/v1/conversations/{conversationId}/messages/{messageId}", api.handleEditMessage)
	mux.HandleFunc("DELETE /api/v1/conversations/{conversationId}/messages/{messageId}", api.handleDeleteMessageForMe)
	mux.HandleFunc("POST /api/v1/conversations/{conversationId}/messages/{messageId}/forward", api.handleForwardMessage)
	mux.HandleFunc("POST /api/v1/conversations/{conversationId}/messages/{messageId}/favorite", api.handleFavoriteMessage)
	mux.HandleFunc("DELETE /api/v1/conversations/{conversationId}/messages/{messageId}/favorite", api.handleUnfavoriteMessage)
